...
<section id="intro">
    <div style="border: 1px solid #F9D9D9; padding-left: 10%; padding-top: 5%;padding-bottom: 20%; background-color: #F9D9D9; width: 100%; height: 100%;">
        <form method="get" action="searchbyname.php" onclick="return validateForm()">
          <p>กรุณากรอกชื่อ: <<input type="text" class="form-control" name="Sname" placeholder="ชื่อ" pattern="[ก-ฮะาิีึืุูเแัโำไใ์็ฤฦ่้๊๋]{2,100}" title="กรุณากรอกชื่อเป็นภาษาไทย: กฤตภาสต์" style="width: 30%;" required=""> <br> </p>
    ...
    if (isset($_GET['Sname'])) {
        ...
        $sql = "select * from donor where f_name = '$first' ";

      ...
      <body >
        ...
        <section id="intro">
          <div style="border: 1px solid #F9D9D9; padding-left: 10%; padding-top: 5%;padding-bottom: 20%; background-color: #F9D9D9; width: 100%; height: 100%;">
            <form method="post" action="testedit.php" onsubmit="return validateForm();">
              <p>โปรดกรอกเลขประจำตัวประชาชนที่ต้องการ:  <input type="text" pattern="[0-9]{13}" maxlength="13" class="form-control" name="cid" id="cid" title="เช่น 85711xxxxxxxx" style="width: 30%;"> </p>
          ...
          /*if ( isset($_POST['cid']) ){
            ...
            echo "$id";
*/
           // $sql = "select cid,f_name,l_name from donor";
           ...
           // $result = $conn->query($sql);
            ...
            $sql = "select h_name from user where username='redcrossth'";
            $result = $conn->query($sql);
